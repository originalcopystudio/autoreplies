...
export const metadata: Metadata = {
  title: "Instagram Comment to DM Templates - AutoReplies",
  description:
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-white/10 bg-[#0E0C0A]/55">
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 py-16 sm:px-6 lg:grid-cols-[0.88fr_1.12fr] lg:px-8 lg:py-20">
          <div>
            <p className="text-sm font-bold uppercase tracking-wide text-[#F0A24A]">
            ...
            >
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {template.keywords.map((keyword) => (
                  <span
                    key={keyword}
                    className="border border-white/10 bg-[#0E0C0A] px-2 py-1 text-xs font-semibold text-zinc-300"
                  >
                    {keyword}
                  </span>
                ))}
              ...
              <div className="mt-auto grid gap-2 pt-6">
                ...
                <Link
                  ...
                  className="inline-flex w-full items-center justify-center bg-[#F0A24A] px-4 py-3 text-sm font-bold text-[#141210] transition hover:bg-[#F7B96B]"
                >
                  Use this template
                </Link>
              </div>
